 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(P,T){var R=P.length;P.push(T);e:for(;0<R;){var Q=R-1>>>1,Z=P[Q];if(0<a(Z,T))P[Q]=T,P[R]=Z,R=Q;else break e}}function s(P){return P.length===0?null:P[0]}function t(P){if(P.length===0)return null;var T=P[0],R=P.pop();if(R!==T){P[0]=R;e:for(var Q=0,Z=P.length,pt=Z>>>1;Q<pt;){var kn=2*(Q+1)-1,Aa=P[kn],Sn=kn+1,dt=P[Sn];if(0>a(Aa,R))Sn<Z&&0>a(dt,Aa)?(P[Q]=dt,P[Sn]=R,Q=Sn):(P[Q]=Aa,P[kn]=R,Q=kn);else if(Sn<Z&&0>a(dt,R))P[Q]=dt,P[Sn]=R,Q=Sn;else break e}}return T}function a(P,T){var R=P.sortIndex-T.sortIndex;return R!==0?R:P.id-T.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var r=Date,o=r.now();e.unstable_now=function(){return r.now()-o}}var i=[],c=[],d=1,f=null,g=3,y=!1,j=!1,_=!1,E=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h(P){for(var T=s(c);T!==null;){if(T.callback===null)t(c);else if(T.startTime<=P)t(c),T.sortIndex=T.expirationTime,n(i,T);else break;T=s(c)}}function v(P){if(_=!1,h(P),!j)if(s(i)!==null)j=!0,Oa(k);else{var T=s(c);T!==null&&Ma(v,T.startTime-P)}}function k(P,T){j=!1,_&&(_=!1,p(N),N=-1),y=!0;var R=g;try{for(h(T),f=s(i);f!==null&&(!(f.expirationTime>T)||P&&!Re());){var Q=f.callback;if(typeof Q=="function"){f.callback=null,g=f.priorityLevel;var Z=Q(f.expirationTime<=T);T=e.unstable_now(),typeof Z=="function"?f.callback=Z:f===s(i)&&t(i),h(T)}else t(i);f=s(i)}if(f!==null)var pt=!0;else{var kn=s(c);kn!==null&&Ma(v,kn.startTime-T),pt=!1}return pt}finally{f=null,g=R,y=!1}}var x=!1,C=null,N=-1,F=5,I=-1;function Re(){return!(e.unstable_now()-I<F)}function vs(){if(C!==null){var P=e.unstable_now();I=P;var T=!0;try{T=C(!0,P)}finally{T?js():(x=!1,C=null)}}else x=!1}var js;if(typeof u=="function")js=function(){u(vs)};else if(typeof MessageChannel<"u"){var uo=new MessageChannel,gp=uo.port2;uo.port1.onmessage=vs,js=function(){gp.postMessage(null)}}else js=function(){E(vs,0)};function Oa(P){C=P,x||(x=!0,js())}function Ma(P,T){N=E(function(){P(e.unstable_now())},T)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){j||y||(j=!0,Oa(k))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return s(i)},e.unstable_next=function(P){switch(g){case 1:case 2:case 3:var T=3;break;default:T=g}var R=g;g=T;try{return P()}finally{g=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,T){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var R=g;g=P;try{return T()}finally{g=R}},e.unstable_scheduleCallback=function(P,T,R){var Q=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?Q+R:Q):R=Q,P){case 1:var Z=-1;break;case 2:Z=250;break;case 5:Z=1073741823;break;case 4:Z=1e4;break;default:Z=5e3}return Z=R+Z,P={id:d++,callback:T,priorityLevel:P,startTime:R,expirationTime:Z,sortIndex:-1},R>Q?(P.sortIndex=R,n(c,P),s(i)===null&&P===s(c)&&(_?(p(N),N=-1):_=!0,Ma(v,R-Q))):(P.sortIndex=Z,n(i,P),j||y||(j=!0,Oa(k))),P},e.unstable_shouldYield=Re,e.unstable_wrapCallback=function(P){var T=g;return function(){var R=g;g=T;try{return P.apply(this,arguments)}finally{g=R}}}})(Zi);qi.exports=Zi;var Fp=qi.exports;/**
 * @license React
...
</code></pre>`,Hm=({prev:e,next:n})=>m.jsx(L,{version:Fm,title:Um,description:Bm,html:Vm,prev:e,next:n}),Wm="0.4.0",Qm="Multi Sig Wallet",Ym="multi sig wallet",Km=`<p>Example of a multi sig wallet</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Xm=({prev:e,next:n})=>m.jsx(L,{version:Wm,title:Qm,description:Ym,html:Km,prev:e,next:n}),Gm="0.4.0",qm="Rebase token",Zm="Rebase token in Vyper",Jm=`<p>Example of rebase token</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">transfer</span>(<span class="hljs-params">dst: address, amt: uint256</span>):
    ...
    <span class="hljs-keyword">else</span>:
        ...
        <span class="hljs-variable language_">self</span>.slices[msg.sender] -= s
        <span class="hljs-variable language_">self</span>.slices[dst] += s
</code></pre>`,eg=({prev:e,next:n})=>m.jsx(L,{version:Gm,title:qm,description:Zm,html:Jm,prev:e,next:n}),ng="0.4.0",sg="Constants",tg="Constants in Vyper",ag=`<p>Constants are variables that cannot change.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,lg=({prev:e,next:n})=>m.jsx(L,{version:ng,title:sg,description:tg,html:ag,prev:e,next:n}),rg="0.4.0",og="Constructor",ig="Constructor in Vyper",cg=`<p><code>__init__</code> is a special function that is executed only once when the contract is deployed.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,ug=({prev:e,next:n})=>m.jsx(L,{version:rg,title:og,description:ig,html:cg,prev:e,next:n}),pg="0.4.0",dg="Create New Contract",fg="Create new contract in Vyper",hg=`<p>Vyper contracts can deploy new contracts using the function <code>create_minimal_proxy_to</code>.</p>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">deploy_test</span>(<span class="hljs-params">master_copy: address</span>):
    ...
    log Log(addr)
</code></pre>`,mg=({prev:e,next:n})=>m.jsx(L,{version:pg,title:dg,description:fg,html:hg,prev:e,next:n}),gg="0.4.0",yg="Default Function",vg="Default function in Vyper",jg=`<p>A contract can have a default function, executed when a function that does not exist is called. This is the same function as the fallback function in Solidity.</p>
...
</code></pre>`,_g=({prev:e,next:n})=>m.jsx(L,{version:gg,title:yg,description:vg,html:jg,prev:e,next:n}),wg="0.4.0",xg="Curve Add and Remove Liquidity",kg="Curve Add and Remove Liquidity",Sg=`<p>Add and remove liquidity from Curve pools</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Eg=({prev:e,next:n})=>m.jsx(L,{version:wg,title:xg,description:kg,html:Sg,prev:e,next:n}),Cg="0.4.0",bg="Curve Swap",Pg="Curve Swap",Ng=`<p>Swap tokens on Curve</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Tg=({prev:e,next:n})=>m.jsx(L,{version:Cg,title:bg,description:Pg,html:Ng,prev:e,next:n}),Rg="0.4.0",$g="Delegate Call",Lg="Delegate call in Vyper",Ig=`<p>When contract <code>A</code> delegates call to contract <code>B</code>, <code>B</code>&#39;s code will be executed inside contract <code>A</code>. This will update state variables and Ether balance inside contract <code>A</code> and not <code>B</code>.</p>
...
</code></pre>`,zg=({prev:e,next:n})=>m.jsx(L,{version:Rg,title:$g,description:Lg,html:Ig,prev:e,next:n}),Dg="0.4.0",Og="Dynamic Arrays",Mg="Dynamic arrays in Vyper",Ag=`<p>Dynamic arrays are bounded arrays whose length can change. The length of the array cannot exceed the maximum length set where the array is declared.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Fg=({prev:e,next:n})=>m.jsx(L,{version:Dg,title:Og,description:Mg,html:Ag,prev:e,next:n}),Ug="0.4.0",Bg="Error",Vg="Error in Vyper",Hg=`<p>Use <code>assert</code> and <code>raise</code> to check inputs and validate state.</p>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">set_owner</span>(<span class="hljs-params">owner: address</span>):
    ...
    <span class="hljs-variable language_">self</span>.owner = owner
</code></pre>`,Wg=({prev:e,next:n})=>m.jsx(L,{version:Ug,title:Bg,description:Vg,html:Hg,prev:e,next:n}),Qg="0.4.0",Yg="Event",Kg="Event in Vyper",Xg=`<p>Events write logs to the blockchain, commonly used by application to monitor blockchain state and as a cheaper alternative to store data on the blockchain without using state variables.</p>
...
</code></pre>`,Gg=({prev:e,next:n})=>m.jsx(L,{version:Qg,title:Yg,description:Kg,html:Xg,prev:e,next:n}),qg="0.4.0",Zg="For Loop",Jg="For loop in Vyper",ey=`<p>There are 2 ways to loop through an array, using <code>range</code> and directly looping through array elements.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,ny=({prev:e,next:n})=>m.jsx(L,{version:qg,title:Zg,description:Jg,html:ey,prev:e,next:n}),sy="0.4.0",ty="Function",ay="Function in Vyper",ly=`<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,ry=({prev:e,next:n})=>m.jsx(L,{version:sy,title:ty,description:ay,html:ly,prev:e,next:n}),oy="0.4.0",iy="Hash Function",cy="Hash function in Vyper",uy=`<p>Vyper supports the same hash function available in Solidity, <code>keccack256</code>.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,py=({prev:e,next:n})=>m.jsx(L,{version:oy,title:iy,description:cy,html:uy,prev:e,next:n}),dy="0.4.0",fy="Hello World",hy="Hello world in Vyper",my=`<p><code>pragma</code> specifies the compiler version of Vyper.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,gy=({prev:e,next:n})=>m.jsx(L,{version:dy,title:fy,description:hy,html:my,prev:e,next:n}),yy="0.4.0",vy="If Else Conditional Statement",jy="If else conditional statement in Vyper",_y=`<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,wy=({prev:e,next:n})=>m.jsx(L,{version:yy,title:vy,description:jy,html:_y,prev:e,next:n}),xy="0.4.0",ky="Immutable",Sy="Immutable in Vyper",Ey=`<p>Immutable variables are like constants except value are assigned when the contract is deployed.</p>
...
</code></pre>`,Cy=({prev:e,next:n})=>m.jsx(L,{version:xy,title:ky,description:Sy,html:Ey,prev:e,next:n}),by="0.4.0",Py="Imports",Ny="Imports in Vyper",Ty=`<p>Different ways to import Vyper files</p>
<pre><code>├── example.vy
└── math.vy
...
</code></pre>`,Ry=({prev:e,next:n})=>m.jsx(L,{version:by,title:Py,description:Ny,html:Ty,prev:e,next:n}),$y="0.4.0",Ly="Interface",Iy="Interface in Vyper",zy=`<p>Use <code>interface</code> to call other smart contracts.</p>
...
</code></pre>`,Dy=({prev:e,next:n})=>m.jsx(L,{version:$y,title:Ly,description:Iy,html:zy,prev:e,next:n}),Oy="0.4.0",My="Internal and External Functions",Ay="Internal and external functions in Vyper",Fy=`<p><code>@internal</code> functions can only be called inside the contract.</p>
...
</code></pre>`,Uy=({prev:e,next:n})=>m.jsx(L,{version:Oy,title:My,description:Ay,html:Fy,prev:e,next:n}),By="0.4.0",Vy="Modules",Hy="Modules in Vyper",Wy=`<p>Reuse code with modules.</p>
...
</code></pre>`,Qy=({prev:e,next:n})=>m.jsx(L,{version:By,title:Vy,description:Hy,html:Wy,prev:e,next:n}),Yy="0.4.0",Ky="Payable",Xy="Payable in Vyper",Gy=`<p>Functions declared with <code>@payable</code> can receive Ether.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">pay</span>():
    ...
    <span class="hljs-variable language_">self</span>.owner = msg.sender
</code></pre>`,qy=({prev:e,next:n})=>m.jsx(L,{version:Yy,title:Ky,description:Xy,html:Gy,prev:e,next:n}),Zy="0.4.0",Jy="Debug with Print",ev="Debug with Print",nv=`<p>Use the built-in function <code>print</code> to debug smart contracts.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,sv=({prev:e,next:n})=>m.jsx(L,{version:Zy,title:Jy,description:ev,html:nv,prev:e,next:n}),tv="0.4.0",av="Private and Public State Variables",lv="Private and public state variables in Vyper",rv=`<p>Private state variables cannot be accessed from outside the contract.</p>
...
</code></pre>`,ov=({prev:e,next:n})=>m.jsx(L,{version:tv,title:av,description:lv,html:rv,prev:e,next:n}),iv="0.4.0",cv="Raw Call",uv="Raw call in Vyper",pv=`<p><code>raw_call</code> is a low level function. It is used to call and send Ether to other functions.</p>
...
</code></pre>`,dv=({prev:e,next:n})=>m.jsx(L,{version:iv,title:cv,description:uv,html:pv,prev:e,next:n}),fv="0.4.0",hv="Re-Entrancy Lock",mv="Re-entrancy lock in Vyper",gv=`<p>Vyper has a handy way to secure your contract from re-entrancy.</p>
...
</code></pre>`,yv=({prev:e,next:n})=>m.jsx(L,{version:fv,title:hv,description:mv,html:gv,prev:e,next:n}),vv="0.4.0",jv="Data Types - References",_v="References in Vyper",wv=`<p>References types are data types that are passed by their reference, pointer to where the actual data is stored.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,xv=({prev:e,next:n})=>m.jsx(L,{version:vv,title:jv,description:_v,html:wv,prev:e,next:n}),kv="0.4.0",Sv="Self Destruct",Ev="Self destruct in Vyper",Cv=`<p><code>selfdestruct</code> deletes the contract from the blockchain. It takes a single input, an address to send all of Ether stored in the contract.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">kill</span>():
    selfdestruct(msg.sender)
</code></pre>`,bv=({prev:e,next:n})=>m.jsx(L,{version:kv,title:Sv,description:Ev,html:Cv,prev:e,next:n}),Pv="0.4.0",Nv="Send Ether",Tv="Send ETH in Vyper",Rv=`<p>There are two ways to send Ether from a contract, <code>send</code> and <code>raw_call</code>. Here we introduce the simpler function to use, <code>send</code>.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,$v=({prev:e,next:n})=>m.jsx(L,{version:Pv,title:Nv,description:Tv,html:Rv,prev:e,next:n}),Lv="0.4.0",Iv="Unsafe Math",zv="Unsafe math in Vyper",Dv=`<p>Critical math checks such as overflow, underflow and division by 0 can be skipped using unsafe functions</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Ov=({prev:e,next:n})=>m.jsx(L,{version:Lv,title:Iv,description:zv,html:Dv,prev:e,next:n}),Mv="0.4.0",Av="Data Types - Values",Fv="Values in Vyper",Uv=`<p>Some values available in Vyper</p>
<ul>
...
</code></pre>`,Bv=({prev:e,next:n})=>m.jsx(L,{version:Mv,title:Av,description:Fv,html:Uv,prev:e,next:n}),Vv="0.4.0",Hv="Verify Signature",Wv="Verify signature in Vyper",Qv=`<p>Signing and verifying signature takes 3 steps.</p>
<ol>
...
</code></pre>`,Yv=({prev:e,next:n})=>m.jsx(L,{version:Vv,title:Hv,description:Wv,html:Qv,prev:e,next:n}),Kv="0.4.0",Xv="View and Pure Functions",Gv="View and pure functions in Vyper",qv=`<p>Both <code>pure</code> and <code>view</code> functions are read only function, they cannot write anything to the blockchain.</p>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">addNum</span>(<span class="hljs-params">x: uint256</span>) -&gt; uint256:
    <span class="hljs-keyword">return</span> x + <span class="hljs-variable language_">self</span>.num
</code></pre>`,Zv=({prev:e,next:n})=>m.jsx(L,{version:Kv,title:Xv,description:Gv,html:qv,prev:e,next:n}),Jv="0.4.0",e0="What's New",n0="What's new in Vyper 0.4",s0=`<h3>pragma version</h3>
<p>0.3</p>
...
`,t0=({prev:e,next:n})=>m.jsx(L,{version:Jv,title:e0,description:n0,html:s0,prev:e,next:n}),a0=({size:e,className:n=""})=>m.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:2,stroke:"currentColor",width:e,height:e,className:n,children:m.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"})}),l0="_component_efeb7_1",r0="_icon_efeb7_8",o0="_input_efeb7_12",fl={component:l0,icon:r0,input:o0},i0=({value:e,onChange:n})=>{function s(t){n(t.target.value)}return m.jsxs("div",{className:fl.component,children:[m.jsx(a0,{size:18,className:fl.icon}),m.jsx("input",{className:fl.input,placeholder:"Search",value:e,onChange:s})]})};var c0="Expected a function",Ri=NaN,u0="[object Symbol]",p0=/^\s+|\s+$/g,d0=/^[-+]0x[0-9a-f]+$/i,f0=/^0b[01]+$/i,h0=/^0o[0-7]+$/i,m0=parseInt,g0=typeof ft=="object"&&ft&&ft.Object===Object&&ft,y0=typeof self=="object"&&self&&self.Object===Object&&self,v0=g0||y0||Function("return this")(),j0=Object.prototype,_0=j0.toString,w0=Math.max,x0=Math.min,hl=function(){return v0.Date.now()};function k0(e,n,s){var t,a,l,r,o,i,c=0,d=!1,f=!1,g=!0;if(typeof e!="function")throw new TypeError(c0);n=$i(n)||0,pr(s)&&(d=!!s.leading,f="maxWait"in s,l=f?w0($i(s.maxWait)||0,n):l,g="trailing"in s?!!s.trailing:g);function y(x){var C=t,N=a;return t=a=void 0,c=x,r=e.apply(N,C),r}function j(x){return c=x,o=setTimeout(p,n),d?y(x):r}function _(x){var C=x-i,N=x-c,F=n-C;return f?x0(F,l-N):F}function E(x){var C=x-i,N=x-c;return i===void 0||C>=n||C<0||f&&N>=l}function p(){var x=hl();if(E(x))return u(x);o=setTimeout(p,_(x))}function u(x){return o=void 0,g&&t?y(x):(t=a=void 0,r)}function h(){o!==void 0&&clearTimeout(o),c=0,t=i=a=o=void 0}function v(){return o===void 0?r:u(hl())}function k(){var x=hl(),C=E(x);if(t=arguments,a=this,i=x,C){if(o===void 0)return j(i);if(f)return o=setTimeout(p,n),y(i)}return o===void 0&&(o=setTimeout(p,n)),r}return k.cancel=h,k.flush=v,k}function pr(e){var n=typeof e;return!!e&&(n=="object"||n=="function")}function S0(e){return!!e&&typeof e=="object"}function E0(e){return typeof e=="symbol"||S0(e)&&_0.call(e)==u0}function $i(e){if(typeof e=="number")return e;if(E0(e))return Ri;if(pr(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=pr(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=e.replace(p0,"");var s=f0.test(e);return s||h0.test(e)?m0(e.slice(2),s?2:8):d0.test(e)?Ri:+e}var C0=k0;const b0=Oi(C0),P0={leading:!1,trailing:!0};function N0(e,n,s){return S.useCallback(b0(e,n,P0),s)}function T0(e,n){let s=e;for(let t=0;t<n.length;t++){const a=n[t];s[a]||(s[a]={}),t<n.length-1?s=s[a]:s[a][""]={}}}function R0(e){if(!e)return[];const n=[],s=[];let t="",a=!1;for(n.push(["",0,e]);n.length>0;){const[l,r,o]=n.pop();a&&(t=t.slice(0,r-1),a=!1),t+=l;const i=Object.keys(o);if(i.length>0)for(let c=0;c<i.length;c++){const d=i[c];n.push([d,r+1,o[d]])}else s.push(t),a=!0}return s}function $0(e,n){let s=e;for(let a=0;a<n.length;a++){if(!s)return[];s=s[n[a]]}const t=R0(s);return t.length==0?[]:t.sort().map(a=>n+a)}const L0=["/whats-new"],I0=["/view-pure-functions"],z0=["/view-pure-functions"],D0=["/view-pure-functions","/payable","/internal-external-functions","/hash-function","/function","/default-function"],O0=["/verify-signature"],M0=["/verify-signature"],A0=["/verify-signature"],F0=["/values","/references"],U0=["/values","/references"],B0=["/values","/references"],V0=["/values"],H0=["/values"],W0=["/values","/references","/private-public-state-variables"],Q0=["/values","/references","/private-public-state-variables"],Y0=["/values"],K0=["/values"],X0=["/values"],G0=["/values"],q0=["/values"],Z0=["/values"],J0=["/values"],ej=["/unsafe-math"],nj=["/unsafe-math"],sj=["/unsafe-math","/app/lerp"],tj=["/send-ether"],aj=["/send-ether"],lj=["/send-ether","/raw-call"],rj=["/send-ether","/payable","/default-function"],oj=["/self-destruct"],ij=["/self-destruct"],cj=["/self-destruct"],uj=["/references"],pj=["/references"],dj=["/references","/dynamic-arrays"],fj=["/references","/dynamic-arrays"],hj=["/references"],mj=["/references"],gj=["/references"],yj=["/references"],vj=["/re-entrancy-lock"],jj=["/re-entrancy-lock"],_j=["/raw-call"],wj=["/raw-call","/delegate-call"],xj=["/private-public-state-variables"],kj=["/print"],Sj=["/print"],Ej=["/modules"],Cj=["/modules"],bj=["/modules"],Pj=["/modules"],Nj=["/internal-external-functions"],Tj=["/internal-external-functions"],Rj=["/interface"],$j=["/imports"],Lj=["/immutable"],Ij=["/immutable"],zj=["/immutable","/constants"],Dj=["/immutable","/constants"],Oj=["/if-else"],Mj=["/if-else"],Aj=["/hello-world"],Fj=["/hello-world"],Uj=["/hello-world"],Bj=["/hash-function"],Vj=["/hash-function"],Hj=["/for-loop"],Wj=["/for-loop"],Qj=["/for-loop"],Yj=["/event"],Kj=["/event"],Xj=["/error"],Gj=["/error"],qj=["/dynamic-arrays"],Zj=["/delegate-call"],Jj=["/defi/curve-swap","/defi/curve-liquidity"],e1=["/defi/curve-swap"],n1=["/defi/curve-swap","/defi/curve-liquidity"],s1=["/defi/curve-swap","/defi/curve-liquidity"],t1=["/defi/curve-liquidity"],a1=["/default-function"],l1=["/default-function"],r1=["/create-new-contract"],o1=["/create-new-contract"],i1=["/create-new-contract"],c1=["/constructor"],u1=["/app/rebase-token"],p1=["/app/rebase-token"],d1=["/app/rebase-token","/app/multi-sig-wallet","/app/lerp"],f1=["/app/multi-sig-wallet"],h1=["/app/multi-sig-wallet"],m1=["/app/multi-sig-wallet"],g1=["/app/lerp"],Li={vyper:L0,"0.4":["/whats-new"],view:I0,pure:z0,function:["/view-pure-functions","/payable","/internal-external-functions","/hash-function","/function","/default-function"],functions:D0,verify:O0,signature:M0,ecrecover:A0,data:F0,type:U0,types:B0,value:V0,values:H0,variable:W0,variables:Q0,bool:Y0,int128:K0,uint256:X0,decimals:G0,address:q0,bytes32:Z0,Bytes:J0,String:["/values"],gas:ej,unsafe:nj,math:sj,send:tj,ether:aj,raw_call:lj,payable:rj,selfdestruct:oj,self:ij,destruct:cj,reference:uj,references:pj,array:dj,arrays:fj,struct:hj,structs:mj,HashMap:gj,mapping:yj,"re-entrancy":["/re-entrancy-lock"],lock:vj,nonreentrant:jj,raw:_j,call:wj,private:["/private-public-state-variables"],public:["/private-public-state-variables"],state:xj,debug:kj,print:Sj,modules:Ej,use:Cj,exports:bj,initializes:Pj,internal:Nj,external:Tj,interface:["/interface"],interfaces:Rj,imports:$j,immutable:Lj,immutables:Ij,constant:zj,constants:Dj,if:["/if-else"],else:["/if-else"],conditional:Oj,statement:Mj,hello:Aj,world:Fj,version:Uj,hash:Bj,keccack256:Vj,for:["/for-loop"],loop:Hj,loops:Wj,range:Qj,event:Yj,events:Kj,error:Xj,errors:Gj,dynamic:qj,delegate:Zj,curve:Jj,swap:e1,defi:n1,amm:s1,add:t1,"remove liquidity":["/defi/curve-liquidity"],default:["/default-function"],__default__:a1,fallback:l1,create:r1,new:["/create-new-contract"],contract:o1,create_minimal_proxy_to:i1,constructor:c1,rebase:u1,token:p1,app:d1,multi:f1,sig:h1,wallet:m1,lerp:g1},Ii={"/whats-new":["vyper",.4],"/view-pure-functions":["view","pure","function","functions"],"/verify-signature":["verify","signature","ecrecover"],"/values":["data","type","types","value","values","variable","variables","bool","int128","uint256","decimals","address","bytes32","Bytes","String"],"/unsafe-math":["gas","unsafe","math"],"/send-ether":["send","ether","raw_call","payable"],"/self-destruct":["selfdestruct","self","destruct"],"/references":["data","type","types","reference","references","variable","variables","array","arrays","struct","structs","HashMap","mapping"],"/re-entrancy-lock":["re-entrancy","lock","nonreentrant"],"/raw-call":["raw","call","raw_call"],"/private-public-state-variables":["private","public","state","variable","variables"],"/print":["debug","print"],"/payable":["payable","function","functions"],"/modules":["modules","use","exports","initializes"],"/internal-external-functions":["internal","external","function","functions"],"/interface":["interface","interfaces"],"/imports":["imports"],"/immutable":["immutable","immutables","constant","constants"],"/if-else":["if","else","conditional","statement"],"/hello-world":["hello","world","version"],"/hash-function":["hash","keccack256","function","functions"],"/function":["function","functions"],"/for-loop":["for","loop","loops","range"],"/event":["event","events"],"/error":["error","errors"],"/dynamic-arrays":["dynamic","arrays","array"],"/delegate-call":["delegate","call"],"/defi/curve-swap":["curve","swap","defi","amm"],"/defi/curve-liquidity":["curve","add","remove liquidity","defi","amm"],"/default-function":["default","function","functions","__default__","fallback","payable"],"/create-new-contract":["create","new","contract","create_minimal_proxy_to"],"/constructor":["constructor"],"/constants":["constant","constants"],"/app/rebase-token":["rebase","token","app"],"/app/multi-sig-wallet":["app","multi","sig","wallet"],"/app/lerp":["lerp","math","app"]},dr=[];for(const e of Object.keys(Ii))dr.push(...Ii[e]);const mp={};for(let e=0;e<dr.length;e++)T0(mp,dr[e]);function y1(e){return Array.from(new Set(e))}function v1(e){const n=[],s=$0(mp,e.toLowerCase());for(let t=0;t<s.length;t++){const a=s[t];Li[a]&&n.push(...Li[a])}return n}const j1="_component_1aw21_1",_1="_updates_1aw21_8",w1="_search_1aw21_13",x1="_category_1aw21_17",k1="_listItem_1aw21_20",S1="_label_1aw21_28",E1="_header_1aw21_31",C1="_youTube_1aw21_35",b1="_youTubeLogo_1aw21_41",P1="_updraft_1aw21_45",N1="_updraftLogo_1aw21_51",ne={component:j1,updates:_1,search:w1,category:x1,listItem:k1,label:S1,header:E1,youTube:C1,youTubeLogo:b1,updraft:P1,updraftLogo:N1},T1=["2024/11/05 - Multi sig wallet","2024/10/24 - Update re-entrancy","2024/10/10 - Linear interpolation"];function R1(){const[e,n]=S.useState(""),[s,t]=Fh(),[a,l]=S.useState(null);S.useEffect(()=>{const d=s.get("q");d!=null&&d.length>0&&(n(d),r(d,!1))},[]);function r(d,f){const g=d.trim();if(g.length==0){l(null),f&&t({q:""});return}const y=y1(g.split(" ")),j={};for(const _ of y){const E=v1(_);for(const p of E)j[p]=!0}l(j),f&&t({q:g})}const o=N0(d=>r(d,!0),500,[]);function i(d){n(d),o(d)}function c(){return a?Object.keys(a).length==0?m.jsx("div",{children:"No results"}):m.jsx("ul",{className:ne.list,children:ga.filter(({path:d})=>a[d]).map(({path:d,title:f})=>m.jsx("li",{className:ne.listItem,children:m.jsx("a",{href:d,children:f})},d))}):m.jsxs(m.Fragment,{children:[co.map(({routes:d,title:f},g)=>m.jsxs("div",{children:[f&&m.jsx("h3",{className:ne.category,children:f}),m.jsx("ul",{className:ne.list,children:d.map(({path:y,title:j})=>m.jsx("li",{className:ne.listItem,children:m.jsx("a",{href:y,children:j})},y))})]},g)),m.jsxs("div",{children:[m.jsx("h3",{className:ne.category,children:"Translations"}),Gh.map(({lang:d,url:f})=>m.jsx("li",{className:ne.listItem,children:m.jsx("a",{href:f,target:"__blank",children:d})},f))]})]})}return m.jsxs("div",{className:ne.component,children:[m.jsx(hp,{title:"Vyper by Example | 0.4.0",description:"Learn smart contract programming using Vyper"}),m.jsx("h1",{className:ne.header,children:m.jsx("a",{href:"/",children:"Vyper by Example"})}),m.jsx("div",{className:ne.subHeader,children:"v 0.4.0"}),m.jsxs("div",{className:ne.main,children:[m.jsxs("p",{children:["an introduction to ",m.jsx("a",{href:"https://vyper.readthedocs.io",children:"Vyper"})," with simple examples"]}),m.jsxs("div",{className:ne.youTube,children:[m.jsx("img",{src:dp,alt:"logo",className:ne.youTubeLogo}),m.jsx("a",{href:"https://www.youtube.com/@smartcontractprogrammer",target:"__blank",children:"Most code are explained here"})]}),m.jsxs("div",{className:ne.updraft,children:[m.jsx("img",{src:fp,alt:"logo",className:ne.updraftLogo}),m.jsx("a",{href:"https://updraft.cyfrin.io",target:"__blank",children:"Learn more at Cyfrin Updraft"})]}),m.jsx("div",{className:ne.updates,children:T1.map((d,f)=>m.jsx("div",{children:d},f))}),m.jsx("div",{className:ne.search,children:m.jsx(i0,{value:e,onChange:i})}),c()]})]})}const $1=[{path:"/app/lerp",component:Hm},{path:"/app/multi-sig-wallet",component:Xm},{path:"/app/rebase-token",component:eg},{path:"/constants",component:lg},{path:"/constructor",component:ug},{path:"/create-new-contract",component:mg},{path:"/default-function",component:_g},{path:"/defi/curve-liquidity",component:Eg},{path:"/defi/curve-swap",component:Tg},{path:"/delegate-call",component:zg},{path:"/dynamic-arrays",component:Fg},{path:"/error",component:Wg},{path:"/event",component:Gg},{path:"/for-loop",component:ny},{path:"/function",component:ry},{path:"/hash-function",component:py},{path:"/hello-world",component:gy},{path:"/if-else",component:wy},{path:"/immutable",component:Cy},{path:"/imports",component:Ry},{path:"/interface",component:Dy},{path:"/internal-external-functions",component:Uy},{path:"/modules",component:Qy},{path:"/payable",component:qy},{path:"/print",component:sv},{path:"/private-public-state-variables",component:ov},{path:"/raw-call",component:dv},{path:"/re-entrancy-lock",component:yv},{path:"/references",component:xv},{path:"/self-destruct",component:bv},{path:"/send-ether",component:$v},{path:"/unsafe-math",component:Ov},{path:"/values",component:Bv},{path:"/verify-signature",component:Yv},{path:"/view-pure-functions",component:Zv},{path:"/whats-new",component:t0},{path:"",component:R1}];function zi(){const{state:e,init:n}=oo();return S.useLayoutEffect(()=>{n({width:window.document.body.clientWidth})},[]),e.initialized?m.jsx(Ah,{basename:void 0,children:m.jsx($m,{children:m.jsx(zh,{children:$1.map(s=>{const{prev:t,next:a}=nm(s.path);return m.jsx(pp,{path:s.path,element:Ki.createElement(s.component,{prev:t,next:a})},s.path)})})})}):null}const L1=document.getElementById("root"),I1=Zu(L1),Di=document.getElementById("root");Di.hasChildNodes()?qu(Di,m.jsx(xi,{children:m.jsx(zi,{})})):I1.render(m.jsx(xi,{children:m.jsx(zi,{})}));
