...
</code></pre>`,Iv=({prev:e,next:n})=>y.jsx(z,{version:Rv,title:Lv,description:$v,html:zv,prev:e,next:n}),Ov="0.4.0",Dv="Payable",Mv="Payable in Vyper",Av=`<p>Functions declared with <code>@payable</code> can receive Ether.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">pay</span>():
    ...
    <span class="hljs-variable language_">self</span>.owner = msg.sender
</code></pre>`,Fv=({prev:e,next:n})=>y.jsx(z,{version:Ov,title:Dv,description:Mv,html:Av,prev:e,next:n}),Uv="0.4.0",Vv="Debug with Print",Bv="Debug with Print",Hv=`<p>Use the built-in function <code>print</code> to debug smart contracts.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Og=({prev:e,next:n})=>y.jsx(z,{version:Lg,title:$g,description:zg,html:Ig,prev:e,next:n}),Dg="0.4.0",Mg="View and Pure Functions",Ag="View and pure functions in Vyper",Fg=`<p>Both <code>pure</code> and <code>view</code> functions are read only function, they cannot write anything to the blockchain.</p>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">addNum</span>(<span class="hljs-params">x: uint256</span>) -&gt; uint256:
    <span class="hljs-keyword">return</span> x + <span class="hljs-variable language_">self</span>.num
</code></pre>`,Ug=({prev:e,next:n})=>y.jsx(z,{version:Dg,title:Mg,description:Ag,html:Fg,prev:e,next:n}),Vg="0.4.0",Bg="What's New",Hg="What's new in Vyper 0.4",Wg=`<h3>pragma version</h3>
<p>0.3</p>
