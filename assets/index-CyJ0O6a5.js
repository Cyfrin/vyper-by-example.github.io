...
</code></pre>`,Mm=({prev:e,next:n})=>g.jsx(L,{version:zm,title:Im,description:Dm,html:Om,prev:e,next:n}),Am="0.4.0",Fm="Multi Sig Wallet",Um="multi sig wallet",Bm=`<p>Example of a multi sig wallet</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Vm=({prev:e,next:n})=>g.jsx(L,{version:Am,title:Fm,description:Um,html:Bm,prev:e,next:n}),Hm="0.4.0",Wm="Rebase token",Qm="Rebase token in Vyper",Ym=`<p>Example of rebase token</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">transfer</span>(<span class="hljs-params">dst: address, amt: uint256</span>):
    ...
    <span class="hljs-keyword">else</span>:
        ...
        <span class="hljs-variable language_">self</span>.slices[msg.sender] -= s
        <span class="hljs-variable language_">self</span>.slices[dst] += s
</code></pre>`,Km=({prev:e,next:n})=>g.jsx(L,{version:Hm,title:Wm,description:Qm,html:Ym,prev:e,next:n}),Xm="0.4.0",Gm="Constants",qm="Constants in Vyper",Zm=`<p>Constants are variables that cannot change.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Jm=({prev:e,next:n})=>g.jsx(L,{version:Xm,title:Gm,description:qm,html:Zm,prev:e,next:n}),eg="0.4.0",ng="Constructor",sg="Constructor in Vyper",tg=`<p><code>__init__</code> is a special function that is executed only once when the contract is deployed.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,ag=({prev:e,next:n})=>g.jsx(L,{version:eg,title:ng,description:sg,html:tg,prev:e,next:n}),lg="0.4.0",rg="Create New Contract",og="Create new contract in Vyper",ig=`<p>Vyper contracts can deploy new contracts using the function <code>create_minimal_proxy_to</code>.</p>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">deploy_test</span>(<span class="hljs-params">master_copy: address</span>):
    ...
    log Log(addr)
</code></pre>`,cg=({prev:e,next:n})=>g.jsx(L,{version:lg,title:rg,description:og,html:ig,prev:e,next:n}),ug="0.4.0",pg="Default Function",dg="Default function in Vyper",fg=`<p>A contract can have a default function, executed when a function that does not exist is called. This is the same function as the fallback function in Solidity.</p>
...
</code></pre>`,hg=({prev:e,next:n})=>g.jsx(L,{version:ug,title:pg,description:dg,html:fg,prev:e,next:n}),mg="0.4.0",gg="Curve Add and Remove Liquidity",yg="Curve Add and Remove Liquidity",vg=`<p>Add and remove liquidity from Curve pools</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,jg=({prev:e,next:n})=>g.jsx(L,{version:mg,title:gg,description:yg,html:vg,prev:e,next:n}),_g="0.4.0",wg="Curve Swap",xg="Curve Swap",kg=`<p>Swap tokens on Curve</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Sg=({prev:e,next:n})=>g.jsx(L,{version:_g,title:wg,description:xg,html:kg,prev:e,next:n}),Eg="0.4.0",Cg="Delegate Call",bg="Delegate call in Vyper",Pg=`<p>When contract <code>A</code> delegates call to contract <code>B</code>, <code>B</code>&#39;s code will be executed inside contract <code>A</code>. This will update state variables and Ether balance inside contract <code>A</code> and not <code>B</code>.</p>
...
</code></pre>`,Ng=({prev:e,next:n})=>g.jsx(L,{version:Eg,title:Cg,description:bg,html:Pg,prev:e,next:n}),Tg="0.4.0",Rg="Dynamic Arrays",$g="Dynamic arrays in Vyper",Lg=`<p>Dynamic arrays are bounded arrays whose length can change. The length of the array cannot exceed the maximum length set where the array is declared.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,zg=({prev:e,next:n})=>g.jsx(L,{version:Tg,title:Rg,description:$g,html:Lg,prev:e,next:n}),Ig="0.4.0",Dg="Error",Og="Error in Vyper",Mg=`<p>Use <code>assert</code> and <code>raise</code> to check inputs and validate state.</p>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">set_owner</span>(<span class="hljs-params">owner: address</span>):
    ...
    <span class="hljs-variable language_">self</span>.owner = owner
</code></pre>`,Ag=({prev:e,next:n})=>g.jsx(L,{version:Ig,title:Dg,description:Og,html:Mg,prev:e,next:n}),Fg="0.4.0",Ug="Event",Bg="Event in Vyper",Vg=`<p>Events write logs to the blockchain, commonly used by application to monitor blockchain state and as a cheaper alternative to store data on the blockchain without using state variables.</p>
...
</code></pre>`,Hg=({prev:e,next:n})=>g.jsx(L,{version:Fg,title:Ug,description:Bg,html:Vg,prev:e,next:n}),Wg="0.4.0",Qg="For Loop",Yg="For loop in Vyper",Kg=`<p>There are 2 ways to loop through an array, using <code>range</code> and directly looping through array elements.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Xg=({prev:e,next:n})=>g.jsx(L,{version:Wg,title:Qg,description:Yg,html:Kg,prev:e,next:n}),Gg="0.4.0",qg="Function",Zg="Function in Vyper",Jg=`<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,ey=({prev:e,next:n})=>g.jsx(L,{version:Gg,title:qg,description:Zg,html:Jg,prev:e,next:n}),ny="0.4.0",sy="Hash Function",ty="Hash function in Vyper",ay=`<p>Vyper supports the same hash function available in Solidity, <code>keccack256</code>.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,ly=({prev:e,next:n})=>g.jsx(L,{version:ny,title:sy,description:ty,html:ay,prev:e,next:n}),ry="0.4.0",oy="Hello World",iy="Hello world in Vyper",cy=`<p><code>pragma</code> specifies the compiler version of Vyper.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,uy=({prev:e,next:n})=>g.jsx(L,{version:ry,title:oy,description:iy,html:cy,prev:e,next:n}),py="0.4.0",dy="If Else Conditional Statement",fy="If else conditional statement in Vyper",hy=`<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,my=({prev:e,next:n})=>g.jsx(L,{version:py,title:dy,description:fy,html:hy,prev:e,next:n}),gy="0.4.0",yy="Immutable",vy="Immutable in Vyper",jy=`<p>Immutable variables are like constants except value are assigned when the contract is deployed.</p>
...
</code></pre>`,_y=({prev:e,next:n})=>g.jsx(L,{version:gy,title:yy,description:vy,html:jy,prev:e,next:n}),wy="0.4.0",xy="Imports",ky="Imports in Vyper",Sy=`<p>Different ways to import Vyper files</p>
<pre><code>├── example.vy
└── math.vy
...
</code></pre>`,Ey=({prev:e,next:n})=>g.jsx(L,{version:wy,title:xy,description:ky,html:Sy,prev:e,next:n}),Cy="0.4.0",by="Interface",Py="Interface in Vyper",Ny=`<p>Use <code>interface</code> to call other smart contracts.</p>
...
</code></pre>`,Ty=({prev:e,next:n})=>g.jsx(L,{version:Cy,title:by,description:Py,html:Ny,prev:e,next:n}),Ry="0.4.0",$y="Internal and External Functions",Ly="Internal and external functions in Vyper",zy=`<p><code>@internal</code> functions can only be called inside the contract.</p>
...
</code></pre>`,Iy=({prev:e,next:n})=>g.jsx(L,{version:Ry,title:$y,description:Ly,html:zy,prev:e,next:n}),Dy="0.4.0",Oy="Modules",My="Modules in Vyper",Ay=`<p>Reuse code with modules.</p>
...
</code></pre>`,Fy=({prev:e,next:n})=>g.jsx(L,{version:Dy,title:Oy,description:My,html:Ay,prev:e,next:n}),Uy="0.4.0",By="Payable",Vy="Payable in Vyper",Hy=`<p>Functions declared with <code>@payable</code> can receive Ether.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">pay</span>():
    ...
    <span class="hljs-variable language_">self</span>.owner = msg.sender
</code></pre>`,Wy=({prev:e,next:n})=>g.jsx(L,{version:Uy,title:By,description:Vy,html:Hy,prev:e,next:n}),Qy="0.4.0",Yy="Debug with Print",Ky="Debug with Print",Xy=`<p>Use the built-in function <code>print</code> to debug smart contracts.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Gy=({prev:e,next:n})=>g.jsx(L,{version:Qy,title:Yy,description:Ky,html:Xy,prev:e,next:n}),qy="0.4.0",Zy="Private and Public State Variables",Jy="Private and public state variables in Vyper",ev=`<p>Private state variables cannot be accessed from outside the contract.</p>
...
</code></pre>`,nv=({prev:e,next:n})=>g.jsx(L,{version:qy,title:Zy,description:Jy,html:ev,prev:e,next:n}),sv="0.4.0",tv="Raw Call",av="Raw call in Vyper",lv=`<p><code>raw_call</code> is a low level function. It is used to call and send Ether to other functions.</p>
...
</code></pre>`,rv=({prev:e,next:n})=>g.jsx(L,{version:sv,title:tv,description:av,html:lv,prev:e,next:n}),ov="0.4.0",iv="Re-Entrancy Lock",cv="Re-entrancy lock in Vyper",uv=`<p>Vyper has a handy way to secure your contract from re-entrancy.</p>
...
</code></pre>`,pv=({prev:e,next:n})=>g.jsx(L,{version:ov,title:iv,description:cv,html:uv,prev:e,next:n}),dv="0.4.0",fv="Data Types - References",hv="References in Vyper",mv=`<p>References types are data types that are passed by their reference, pointer to where the actual data is stored.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,gv=({prev:e,next:n})=>g.jsx(L,{version:dv,title:fv,description:hv,html:mv,prev:e,next:n}),yv="0.4.0",vv="Self Destruct",jv="Self destruct in Vyper",_v=`<p><code>selfdestruct</code> deletes the contract from the blockchain. It takes a single input, an address to send all of Ether stored in the contract.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">kill</span>():
    selfdestruct(msg.sender)
</code></pre>`,wv=({prev:e,next:n})=>g.jsx(L,{version:yv,title:vv,description:jv,html:_v,prev:e,next:n}),xv="0.4.0",kv="Send Ether",Sv="Send ETH in Vyper",Ev=`<p>There are two ways to send Ether from a contract, <code>send</code> and <code>raw_call</code>. Here we introduce the simpler function to use, <code>send</code>.</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Cv=({prev:e,next:n})=>g.jsx(L,{version:xv,title:kv,description:Sv,html:Ev,prev:e,next:n}),bv="0.4.0",Pv="Unsafe Math",Nv="Unsafe math in Vyper",Tv=`<p>Critical math checks such as overflow, underflow and division by 0 can be skipped using unsafe functions</p>
<pre><code class="language-vyper"><span class="hljs-comment"># pragma version ^0.4.0</span>
...
</code></pre>`,Rv=({prev:e,next:n})=>g.jsx(L,{version:bv,title:Pv,description:Nv,html:Tv,prev:e,next:n}),$v="0.4.0",Lv="Data Types - Values",zv="Values in Vyper",Iv=`<p>Some values available in Vyper</p>
<ul>
...
</code></pre>`,Dv=({prev:e,next:n})=>g.jsx(L,{version:$v,title:Lv,description:zv,html:Iv,prev:e,next:n}),Ov="0.4.0",Mv="Verify Signature",Av="Verify signature in Vyper",Fv=`<p>Signing and verifying signature takes 3 steps.</p>
<ol>
...
</code></pre>`,Uv=({prev:e,next:n})=>g.jsx(L,{version:Ov,title:Mv,description:Av,html:Fv,prev:e,next:n}),Bv="0.4.0",Vv="View and Pure Functions",Hv="View and pure functions in Vyper",Wv=`<p>Both <code>pure</code> and <code>view</code> functions are read only function, they cannot write anything to the blockchain.</p>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">addNum</span>(<span class="hljs-params">x: uint256</span>) -&gt; uint256:
    <span class="hljs-keyword">return</span> x + <span class="hljs-variable language_">self</span>.num
</code></pre>`,Qv=({prev:e,next:n})=>g.jsx(L,{version:Bv,title:Vv,description:Hv,html:Wv,prev:e,next:n}),Yv="0.4.0",Kv="What's New",Xv="What's new in Vyper 0.4",Gv=`<h3>pragma version</h3>
<p>0.3</p>
...
`,qv=({prev:e,next:n})=>g.jsx(L,{version:Yv,title:Kv,description:Xv,html:Gv,prev:e,next:n}),Zv=({size:e,className:n=""})=>g.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:2,stroke:"currentColor",width:e,height:e,className:n,children:g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"})}),Jv="_component_efeb7_1",e0="_icon_efeb7_8",n0="_input_efeb7_12",fl={component:Jv,icon:e0,input:n0},s0=({value:e,onChange:n})=>{function s(t){n(t.target.value)}return g.jsxs("div",{className:fl.component,children:[g.jsx(Zv,{size:18,className:fl.icon}),g.jsx("input",{className:fl.input,placeholder:"Search",value:e,onChange:s})]})};var t0="Expected a function",Ri=NaN,a0="[object Symbol]",l0=/^\s+|\s+$/g,r0=/^[-+]0x[0-9a-f]+$/i,o0=/^0b[01]+$/i,i0=/^0o[0-7]+$/i,c0=parseInt,u0=typeof ft=="object"&&ft&&ft.Object===Object&&ft,p0=typeof self=="object"&&self&&self.Object===Object&&self,d0=u0||p0||Function("return this")(),f0=Object.prototype,h0=f0.toString,m0=Math.max,g0=Math.min,hl=function(){return d0.Date.now()};function y0(e,n,s){var t,a,l,r,o,i,c=0,d=!1,f=!1,m=!0;if(typeof e!="function")throw new TypeError(t0);n=$i(n)||0,pr(s)&&(d=!!s.leading,f="maxWait"in s,l=f?m0($i(s.maxWait)||0,n):l,m="trailing"in s?!!s.trailing:m);function y(x){var C=t,N=a;return t=a=void 0,c=x,r=e.apply(N,C),r}function j(x){return c=x,o=setTimeout(p,n),d?y(x):r}function _(x){var C=x-i,N=x-c,F=n-C;return f?g0(F,l-N):F}function E(x){var C=x-i,N=x-c;return i===void 0||C>=n||C<0||f&&N>=l}function p(){var x=hl();if(E(x))return u(x);o=setTimeout(p,_(x))}function u(x){return o=void 0,m&&t?y(x):(t=a=void 0,r)}function h(){o!==void 0&&clearTimeout(o),c=0,t=i=a=o=void 0}function v(){return o===void 0?r:u(hl())}function k(){var x=hl(),C=E(x);if(t=arguments,a=this,i=x,C){if(o===void 0)return j(i);if(f)return o=setTimeout(p,n),y(i)}return o===void 0&&(o=setTimeout(p,n)),r}return k.cancel=h,k.flush=v,k}function pr(e){var n=typeof e;return!!e&&(n=="object"||n=="function")}function v0(e){return!!e&&typeof e=="object"}function j0(e){return typeof e=="symbol"||v0(e)&&h0.call(e)==a0}function $i(e){if(typeof e=="number")return e;if(j0(e))return Ri;if(pr(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=pr(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=e.replace(l0,"");var s=o0.test(e);return s||i0.test(e)?c0(e.slice(2),s?2:8):r0.test(e)?Ri:+e}var _0=y0;const w0=Oi(_0),x0={leading:!1,trailing:!0};function k0(e,n,s){return S.useCallback(w0(e,n,x0),s)}function S0(e,n){let s=e;for(let t=0;t<n.length;t++){const a=n[t];s[a]||(s[a]={}),t<n.length-1?s=s[a]:s[a][""]={}}}function E0(e){if(!e)return[];const n=[],s=[];let t="",a=!1;for(n.push(["",0,e]);n.length>0;){const[l,r,o]=n.pop();a&&(t=t.slice(0,r-1),a=!1),t+=l;const i=Object.keys(o);if(i.length>0)for(let c=0;c<i.length;c++){const d=i[c];n.push([d,r+1,o[d]])}else s.push(t),a=!0}return s}function C0(e,n){let s=e;for(let a=0;a<n.length;a++){if(!s)return[];s=s[n[a]]}const t=E0(s);return t.length==0?[]:t.sort().map(a=>n+a)}const b0=["/whats-new"],P0=["/view-pure-functions"],N0=["/view-pure-functions"],T0=["/view-pure-functions","/payable","/internal-external-functions","/hash-function","/function","/default-function"],R0=["/verify-signature"],$0=["/verify-signature"],L0=["/verify-signature"],z0=["/values","/references"],I0=["/values","/references"],D0=["/values","/references"],O0=["/values"],M0=["/values"],A0=["/values","/references","/private-public-state-variables"],F0=["/values","/references","/private-public-state-variables"],U0=["/values"],B0=["/values"],V0=["/values"],H0=["/values"],W0=["/values"],Q0=["/values"],Y0=["/values"],K0=["/unsafe-math"],X0=["/unsafe-math"],G0=["/unsafe-math","/app/lerp"],q0=["/send-ether"],Z0=["/send-ether"],J0=["/send-ether","/raw-call"],ej=["/send-ether","/payable","/default-function"],nj=["/self-destruct"],sj=["/self-destruct"],tj=["/self-destruct"],aj=["/references"],lj=["/references"],rj=["/references","/dynamic-arrays"],oj=["/references","/dynamic-arrays"],ij=["/references"],cj=["/references"],uj=["/references"],pj=["/references"],dj=["/re-entrancy-lock"],fj=["/re-entrancy-lock"],hj=["/raw-call"],mj=["/raw-call","/delegate-call"],gj=["/private-public-state-variables"],yj=["/print"],vj=["/print"],jj=["/modules"],_j=["/modules"],wj=["/modules"],xj=["/modules"],kj=["/internal-external-functions"],Sj=["/internal-external-functions"],Ej=["/interface"],Cj=["/imports"],bj=["/immutable"],Pj=["/immutable"],Nj=["/immutable","/constants"],Tj=["/immutable","/constants"],Rj=["/if-else"],$j=["/if-else"],Lj=["/hello-world"],zj=["/hello-world"],Ij=["/hello-world"],Dj=["/hash-function"],Oj=["/hash-function"],Mj=["/for-loop"],Aj=["/for-loop"],Fj=["/for-loop"],Uj=["/event"],Bj=["/event"],Vj=["/error"],Hj=["/error"],Wj=["/dynamic-arrays"],Qj=["/delegate-call"],Yj=["/defi/curve-swap","/defi/curve-liquidity"],Kj=["/defi/curve-swap"],Xj=["/defi/curve-swap","/defi/curve-liquidity"],Gj=["/defi/curve-swap","/defi/curve-liquidity"],qj=["/defi/curve-liquidity"],Zj=["/default-function"],Jj=["/default-function"],e1=["/create-new-contract"],n1=["/create-new-contract"],s1=["/create-new-contract"],t1=["/constructor"],a1=["/app/rebase-token"],l1=["/app/rebase-token"],r1=["/app/rebase-token","/app/multi-sig-wallet","/app/lerp"],o1=["/app/multi-sig-wallet"],i1=["/app/multi-sig-wallet"],c1=["/app/multi-sig-wallet"],u1=["/app/lerp"],Li={vyper:b0,"0.4":["/whats-new"],view:P0,pure:N0,function:["/view-pure-functions","/payable","/internal-external-functions","/hash-function","/function","/default-function"],functions:T0,verify:R0,signature:$0,ecrecover:L0,data:z0,type:I0,types:D0,value:O0,values:M0,variable:A0,variables:F0,bool:U0,int128:B0,uint256:V0,decimals:H0,address:W0,bytes32:Q0,Bytes:Y0,String:["/values"],gas:K0,unsafe:X0,math:G0,send:q0,ether:Z0,raw_call:J0,payable:ej,selfdestruct:nj,self:sj,destruct:tj,reference:aj,references:lj,array:rj,arrays:oj,struct:ij,structs:cj,HashMap:uj,mapping:pj,"re-entrancy":["/re-entrancy-lock"],lock:dj,nonreentrant:fj,raw:hj,call:mj,private:["/private-public-state-variables"],public:["/private-public-state-variables"],state:gj,debug:yj,print:vj,modules:jj,use:_j,exports:wj,initializes:xj,internal:kj,external:Sj,interface:["/interface"],interfaces:Ej,imports:Cj,immutable:bj,immutables:Pj,constant:Nj,constants:Tj,if:["/if-else"],else:["/if-else"],conditional:Rj,statement:$j,hello:Lj,world:zj,version:Ij,hash:Dj,keccack256:Oj,for:["/for-loop"],loop:Mj,loops:Aj,range:Fj,event:Uj,events:Bj,error:Vj,errors:Hj,dynamic:Wj,delegate:Qj,curve:Yj,swap:Kj,defi:Xj,amm:Gj,add:qj,"remove liquidity":["/defi/curve-liquidity"],default:["/default-function"],__default__:Zj,fallback:Jj,create:e1,new:["/create-new-contract"],contract:n1,create_minimal_proxy_to:s1,constructor:t1,rebase:a1,token:l1,app:r1,multi:o1,sig:i1,wallet:c1,lerp:u1},zi={"/whats-new":["vyper",.4],"/view-pure-functions":["view","pure","function","functions"],"/verify-signature":["verify","signature","ecrecover"],"/values":["data","type","types","value","values","variable","variables","bool","int128","uint256","decimals","address","bytes32","Bytes","String"],"/unsafe-math":["gas","unsafe","math"],"/send-ether":["send","ether","raw_call","payable"],"/self-destruct":["selfdestruct","self","destruct"],"/references":["data","type","types","reference","references","variable","variables","array","arrays","struct","structs","HashMap","mapping"],"/re-entrancy-lock":["re-entrancy","lock","nonreentrant"],"/raw-call":["raw","call","raw_call"],"/private-public-state-variables":["private","public","state","variable","variables"],"/print":["debug","print"],"/payable":["payable","function","functions"],"/modules":["modules","use","exports","initializes"],"/internal-external-functions":["internal","external","function","functions"],"/interface":["interface","interfaces"],"/imports":["imports"],"/immutable":["immutable","immutables","constant","constants"],"/if-else":["if","else","conditional","statement"],"/hello-world":["hello","world","version"],"/hash-function":["hash","keccack256","function","functions"],"/function":["function","functions"],"/for-loop":["for","loop","loops","range"],"/event":["event","events"],"/error":["error","errors"],"/dynamic-arrays":["dynamic","arrays","array"],"/delegate-call":["delegate","call"],"/defi/curve-swap":["curve","swap","defi","amm"],"/defi/curve-liquidity":["curve","add","remove liquidity","defi","amm"],"/default-function":["default","function","functions","__default__","fallback","payable"],"/create-new-contract":["create","new","contract","create_minimal_proxy_to"],"/constructor":["constructor"],"/constants":["constant","constants"],"/app/rebase-token":["rebase","token","app"],"/app/multi-sig-wallet":["app","multi","sig","wallet"],"/app/lerp":["lerp","math","app"]},dr=[];for(const e of Object.keys(zi))dr.push(...zi[e]);const mp={};for(let e=0;e<dr.length;e++)S0(mp,dr[e]);function p1(e){return Array.from(new Set(e))}function d1(e){const n=[],s=C0(mp,e.toLowerCase());for(let t=0;t<s.length;t++){const a=s[t];Li[a]&&n.push(...Li[a])}return n}const f1="_component_1aw21_1",h1="_updates_1aw21_8",m1="_search_1aw21_13",g1="_category_1aw21_17",y1="_listItem_1aw21_20",v1="_label_1aw21_28",j1="_header_1aw21_31",_1="_youTube_1aw21_35",w1="_youTubeLogo_1aw21_41",x1="_updraft_1aw21_45",k1="_updraftLogo_1aw21_51",ne={component:f1,updates:h1,search:m1,category:g1,listItem:y1,label:v1,header:j1,youTube:_1,youTubeLogo:w1,updraft:x1,updraftLogo:k1},S1=["2024/11/05 - Multi sig wallet","2024/10/24 - Update re-entrancy","2024/10/10 - Linear interpolation"];function E1(){const[e,n]=S.useState(""),[s,t]=Fh(),[a,l]=S.useState(null);S.useEffect(()=>{const d=s.get("q");d!=null&&d.length>0&&(n(d),r(d,!1))},[]);function r(d,f){const m=d.trim();if(m.length==0){l(null),f&&t({q:""});return}const y=p1(m.split(" ")),j={};for(const _ of y){const E=d1(_);for(const p of E)j[p]=!0}l(j),f&&t({q:m})}const o=k0(d=>r(d,!0),500,[]);function i(d){n(d),o(d)}function c(){return a?Object.keys(a).length==0?g.jsx("div",{children:"No results"}):g.jsx("ul",{className:ne.list,children:ma.filter(({path:d})=>a[d]).map(({path:d,title:f})=>g.jsx("li",{className:ne.listItem,children:g.jsx("a",{href:d,children:f})},d))}):g.jsxs(g.Fragment,{children:[co.map(({routes:d,title:f},m)=>g.jsxs("div",{children:[f&&g.jsx("h3",{className:ne.category,children:f}),g.jsx("ul",{className:ne.list,children:d.map(({path:y,title:j})=>g.jsx("li",{className:ne.listItem,children:g.jsx("a",{href:y,children:j})},y))})]},m)),g.jsxs("div",{children:[g.jsx("h3",{className:ne.category,children:"Translations"}),Gh.map(({lang:d,url:f})=>g.jsx("li",{className:ne.listItem,children:g.jsx("a",{href:f,target:"__blank",children:d})},f))]})]})}return g.jsxs("div",{className:ne.component,children:[g.jsx(hp,{title:"Vyper by Example | 0.4.0",description:"Learn smart contract programming using Vyper"}),g.jsx("h1",{className:ne.header,children:g.jsx("a",{href:"/",children:"Vyper by Example"})}),g.jsx("div",{className:ne.subHeader,children:"v 0.4.0"}),g.jsxs("div",{className:ne.main,children:[g.jsxs("p",{children:["an introduction to ",g.jsx("a",{href:"https://vyper.readthedocs.io",children:"Vyper"})," with simple examples"]}),g.jsxs("div",{className:ne.youTube,children:[g.jsx("img",{src:dp,alt:"logo",className:ne.youTubeLogo}),g.jsx("a",{href:"https://www.youtube.com/@smartcontractprogrammer",target:"__blank",children:"Most code are explained here"})]}),g.jsxs("div",{className:ne.updraft,children:[g.jsx("img",{src:fp,alt:"logo",className:ne.updraftLogo}),g.jsx("a",{href:"https://updraft.cyfrin.io",target:"__blank",children:"Learn more at Cyfrin Updraft"})]}),g.jsx("div",{className:ne.updates,children:S1.map((d,f)=>g.jsx("div",{children:d},f))}),g.jsx("div",{className:ne.search,children:g.jsx(s0,{value:e,onChange:i})}),c()]})]})}const C1=[{path:"/app/lerp",component:Mm},{path:"/app/multi-sig-wallet",component:Vm},{path:"/app/rebase-token",component:Km},{path:"/constants",component:Jm},{path:"/constructor",component:ag},{path:"/create-new-contract",component:cg},{path:"/default-function",component:hg},{path:"/defi/curve-liquidity",component:jg},{path:"/defi/curve-swap",component:Sg},{path:"/delegate-call",component:Ng},{path:"/dynamic-arrays",component:zg},{path:"/error",component:Ag},{path:"/event",component:Hg},{path:"/for-loop",component:Xg},{path:"/function",component:ey},{path:"/hash-function",component:ly},{path:"/hello-world",component:uy},{path:"/if-else",component:my},{path:"/immutable",component:_y},{path:"/imports",component:Ey},{path:"/interface",component:Ty},{path:"/internal-external-functions",component:Iy},{path:"/modules",component:Fy},{path:"/payable",component:Wy},{path:"/print",component:Gy},{path:"/private-public-state-variables",component:nv},{path:"/raw-call",component:rv},{path:"/re-entrancy-lock",component:pv},{path:"/references",component:gv},{path:"/self-destruct",component:wv},{path:"/send-ether",component:Cv},{path:"/unsafe-math",component:Rv},{path:"/values",component:Dv},{path:"/verify-signature",component:Uv},{path:"/view-pure-functions",component:Qv},{path:"/whats-new",component:qv},{path:"",component:E1}];function Ii(){const{state:e,init:n}=oo();return S.useLayoutEffect(()=>{n({width:window.document.body.clientWidth})},[]),e.initialized?g.jsx(Ah,{basename:void 0,children:g.jsx(bm,{children:g.jsx(Ih,{children:C1.map(s=>{const{prev:t,next:a}=nm(s.path);return g.jsx(pp,{path:s.path,element:Ki.createElement(s.component,{prev:t,next:a})},s.path)})})})}):null}const b1=document.getElementById("root"),P1=Zu(b1),Di=document.getElementById("root");Di.hasChildNodes()?qu(Di,g.jsx(xi,{children:g.jsx(Ii,{})})):P1.render(g.jsx(xi,{children:g.jsx(Ii,{})}));
